...
output "address" {
  value       = google_compute_global_address.google_managed_services_range.address
...
output "print-subnet1" {
  value = "${data.google_compute_network.managed_services_network}"
}

output "global_address_ranges_data" {
  value = "${data.google_compute_global_address.google_managed_services_range_data}"
}
